...
Source: MITRE CWE Research Concepts (View 1000)
...
CWE_CATALOG: dict[str, dict[str, str]] = {
    ...
    "CWE-8": {
        ...
        "description": "When an application exposes a remote interface for an entity bean, it might also expose methods that get or set the bean's data.",
        "category": "Security Misconfiguration",
    },
    "CWE-9": {
    ...
    "CWE-16": {
        "name": "Configuration",
        "description": "The application uses an insecure or incorrect configuration setting, which may weaken its overall security posture.",
        "category": "Security Misconfiguration",
        "owasp": "A05:2021",
    },
    "CWE-20": {
    ...
    "CWE-22": {
        ...
        "description": "The product uses external input to construct a pathname that is intended to identify a file or directory that is located underneath a restricted parent directory, but the product does not properly neutralize special elements within the pathname that can cause the pathname to resolve to a location...",
        "category": "Access Control Violation",
        "owasp": "A01:2021",
    },
    "CWE-23": {
    ...
    "CWE-48": {
        ...
        "category": "Insecure File Operation",
    },
    "CWE-49": {
    ...
    "CWE-57": {
        ...
        "description": "The product contains protection mechanisms to restrict access to 'realdir/filename', but it constructs pathnames using external input in the form of 'fakedir/../realdir/filename' that are not handled by those mechanisms.",
        "category": "Other",
    },
    "CWE-58": {
    ...
    "CWE-67": {
        ...
        "description": "The product constructs pathnames from user input, but it does not handle or incorrectly handles a pathname containing a Windows device name such as AUX or CON.",
        "category": "Other",
    },
    "CWE-69": {
    ...
    "CWE-211": {
        ...
        "description": "The product performs an operation that triggers an external diagnostic or error message that is not directly generated or controlled by the product, such as an error generated by the programming language interpreter that a software application uses.",
        "category": "Security Misconfiguration",
    },
    "CWE-212": {
    ...
    "CWE-257": {
        ...
        "description": "The storage of passwords in a recoverable format makes them subject to password reuse attacks by malicious users.",
        "category": "Authentication Weakness",
        "owasp": "A04:2021",
    },
    "CWE-258": {
    ...
    "CWE-308": {
        ...
        "description": "The product uses an authentication algorithm that uses a single factor (e.g., a password) in a security context that should require more than one factor.",
        "category": "Authentication Weakness",
    },
    "CWE-309": {
    ...
    "CWE-310": {
        ...
        "description": "The application contains a general cryptographic weakness, such as misuse of primitives or improper key management, that may undermine data protection.",
        "category": "Cryptographic Weakness",
        "owasp": "A02:2021",
    },
    "CWE-311": {
    ...
    "CWE-328": {
        ...
        "description": "The product uses an algorithm that produces a digest (output value) that does not meet security expectations for a hash function that allows an adversary to reasonably determine the original input (preimage attack), find another input that can produce the same hash (2nd preimage attack), or find ...",
        "category": "Cryptographic Weakness",
        "owasp": "A02:2021",
    },
    "CWE-329": {
    ...
    "CWE-416": {
        "name": "Use After Free",
        "description": "The product reuses or references memory after it has been freed. At some point afterward, the memory may be allocated again and saved in another pointer, while the original pointer references a location somewhere within the new allocation.",
        "category": "Memory Safety Violation",
    },
    "CWE-419": {
    ...
    "CWE-536": {
        ...
        "description": "A servlet error message indicates that there exists an unhandled exception in the web application code and may provide useful information to an attacker.",
        "category": "Security Misconfiguration",
    },
    "CWE-537": {
    ...
    "CWE-616": {
        ...
        "description": "The PHP application uses an old method for processing uploaded files by referencing the four global variables that are set for each file (e.g. $varname, $varname_size, $varname_name, $varname_type).",
        "category": "Other",
    },
    "CWE-617": {
    ...
    "CWE-671": {
        ...
        "description": "The product uses security features in a way that prevents the product's administrator from tailoring security settings to reflect the environment in which the product is being used.",
        "category": "Other",
    },
    "CWE-672": {
    ...
    "CWE-696": {
        ...
        "description": "The product performs multiple related behaviors, but the behaviors are performed in the wrong order in ways that may produce resultant weaknesses.",
        "category": "Other",
    },
    "CWE-697": {
    ...
    "CWE-768": {
        ...
        "description": "The product contains a conditional statement with multiple logical expressions in which one of the non-leading expressions may produce side effects.",
        "category": "Other",
    },
    "CWE-770": {
    ...
    "CWE-827": {
        ...
        "description": "The product does not restrict a reference to a Document Type Definition (DTD) to the intended control sphere.",
        "category": "Other",
    },
    "CWE-828": {
    ...
    "CWE-917": {
        ...
        "description": "The product constructs all or part of an expression language (EL) statement in a framework such as a Java Server Page (JSP) using externally-influenced input from an upstream component, but it does not neutralize or incorrectly neutralizes special elements that could modify the intended EL statem...",
        "category": "Injection Vulnerability",
        "owasp": "A03:2021",
    },
    "CWE-918": {
    ...
    "CWE-1039": {
        ...
        "description": "The product uses an automated mechanism such as machine learning to recognize complex data inputs (e.g.",
        "category": "Other",
    },
    "CWE-1041": {
    ...
    "CWE-1209": {
        ...
        "description": "The reserved bits in a hardware design are not disabled prior to production. Typically, reserved bits are used for future capabilities and should not support any functional logic in the design.",
        "category": "Other",
    },
    "CWE-1220": {
        "name": "Insufficient Granularity of Access Control",
        "description": "The product implements access controls via a policy or other feature with the intention to disable or restrict accesses (reads and/or writes) to assets in a system from untrusted agents.",
        "category": "Access Control Violation",
    },
    "CWE-1221": {
    ...
    "CWE-1222": {
        ...
        "description": "The product defines a large address region protected from modification by the same register lock control bit.",
        "category": "Other",
    },
    "CWE-1223": {
    ...
    "CWE-1249": {
        ...
        "description": "The product provides an application for administrators to manage parts of the underlying operating system, but the application does not accurately identify all of the relevant entities or resources that exist in the OS; that is, the application's model of the OS's state is inconsistent with the O...",
        "category": "Other",
    },
    "CWE-1250": {
    ...
    "CWE-1265": {
        ...
        "description": "The product invokes code that is believed to be reentrant, but the code performs a call that unintentionally produces a nested invocation of the non-reentrant code.",
        "category": "Other",
    },
    "CWE-1266": {
    ...
    "CWE-1434": {
        ...
        "description": "The product has a component that relies on a generative AI/ML model configured with inference parameters that produce an unacceptably high rate of erroneous or unexpected outputs.",
        "category": "Other",
    },
}
